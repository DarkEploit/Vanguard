...
-- // Credits Section
local creds = UiPage:addSection("Developer: XyncStxr")
local UISection2 = UiPage:addSection("Credits: EdgeIY, for the fly, Alwayswin for a few FE features when we merged.")
local UISection3 = UiPage:addSection("Unpatched by: commandblock")
...
-- Functions 
function notify(title, message) print(title, message) end
...
notify("Vanguard", "Script made by XyncStxr")
notify("Vanguard", "Unpatched by commandblock")
